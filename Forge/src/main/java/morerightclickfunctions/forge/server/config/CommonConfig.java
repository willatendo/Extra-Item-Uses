...
public class CommonConfig {
    ...
    public final ForgeConfigSpec.ConfigValue<List<? extends String>> reapables_input;
    public final ForgeConfigSpec.ConfigValue<List<? extends String>> reapables_output;
    ...
    public CommonConfig(ForgeConfigSpec.Builder builder) {
        ...
        this.reapables_input = builder.comment("Sets the input that when right clicked with a hoe will be refined into an output. Must have the same amount of entries as reapables_output").translation("config." + MoreRightClickFunctionsMod.ID + ".reapables_input").defineList("reapables_input", Lists.newArrayList("minecraft:wheat", "minecraft:carrots", "minecraft:potatoes", "minecraft:beetroots"), o -> o instanceof String);
        this.reapables_output = builder.comment("Sets the output that when the input is right clicked with a hoe will be refined into. Must have the same amount of entries as reapables_input").translation("config." + MoreRightClickFunctionsMod.ID + ".reapables_output").defineList("reapables_output", Lists.newArrayList("minecraft:wheat", "minecraft:carrot", "minecraft:potato", "minecraft:beetroot"), o -> o instanceof String);
    }
}
